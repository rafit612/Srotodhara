...
public class SweaterWomenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sweater_women);
        MaterialToolbar toolbar = findViewById(R.id.topAppBarwsw);
        DrawerLayout drawerLayout = findViewById(R.id.drawer_layout_wsw);
        NavigationView navigationView = findViewById(R.id.navigation_view_wsw);
        fstore= FirebaseFirestore.getInstance();
        collectionReference=fstore.collection("women_sweaters");
        recyclerView= findViewById(R.id.recyclewsw);
        storageReference = FirebaseStorage.getInstance().getReference();

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("women_sweaters").orderBy("Price", Query.Direction.ASCENDING);
            ...
            public void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final cosmeticModelClass cosmeticModelClass) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(SweaterWomenActivity.this,ClothLandingActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_home:
                        Intent intent4 = new Intent(SweaterWomenActivity.this, MainActivity.class);
                        startActivity(intent4);
                        break;

                    case R.id.order:
                        Intent intent43 = new Intent(SweaterWomenActivity.this, OrderHistoryActivity.class);
                    ...
                    case R.id.store:
                        ...
                        break;
                    case R.id.About:
                        Toast.makeText(SweaterWomenActivity.this, "About Content Needed",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.women:
                        Intent intent16 = new Intent(SweaterWomenActivity.this, WomenActivity2.class);
                        startActivity(intent16);
                        break;
                    case R.id.men:
                        Intent intent2 = new Intent(SweaterWomenActivity.this, MenActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.cos:
                        Intent intent3 = new Intent(SweaterWomenActivity.this, CosmeticActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.signout:
                        FirebaseAuth.getInstance().signOut();
                        Intent intent31 = new Intent(SweaterWomenActivity.this, LoginwithEmailActivity.class);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            try{
                ...
                Toast.makeText(SweaterWomenActivity.this, "error= "+e, Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
