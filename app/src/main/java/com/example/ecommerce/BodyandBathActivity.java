...
public class BodyandBathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bodyand_bath);

        MaterialToolbar toolbar = findViewById(R.id.topAppBarbb);
        DrawerLayout drawerLayout = findViewById(R.id.drawer_layout_bb);
        NavigationView navigationView = findViewById(R.id.navigation_view_bb);

        fstore=FirebaseFirestore.getInstance();
        collectionReference=fstore.collection("body_and_bath");
        recyclerView= findViewById(R.id.recyclebb);
        storageReference = FirebaseStorage.getInstance().getReference();

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("body_and_bath").orderBy("Price",Query.Direction.ASCENDING);
            ...
            public void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final cosmeticModelClass cosmeticModelClass) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(BodyandBathActivity.this,ClothLandingActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_home:
                        Intent intent4 = new Intent(BodyandBathActivity.this, MainActivity.class);
                        startActivity(intent4);
                        break;

                    case R.id.order:
                        Intent intent43 = new Intent(BodyandBathActivity.this, OrderHistoryActivity.class);
                    ...
                    case R.id.store:
                        ...
                        break;
                    case R.id.About:
                        Toast.makeText(BodyandBathActivity.this, "About Content Needed",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.women:
                        Intent intent16 = new Intent(BodyandBathActivity.this, WomenActivity2.class);
                        startActivity(intent16);
                        break;
                    case R.id.men:
                        Intent intent2 = new Intent(BodyandBathActivity.this, MenActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.cos:
                        Intent intent3 = new Intent(BodyandBathActivity.this, CosmeticActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.signout:
                        FirebaseAuth.getInstance().signOut();
                        Intent intent31 = new Intent(BodyandBathActivity.this, LoginwithEmailActivity.class);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            try{
                ...
                Toast.makeText(BodyandBathActivity.this, "error= "+e, Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
