...
public class PersonalCareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialToolbar toolbar = findViewById(R.id.topAppBarpc);
        DrawerLayout drawerLayout = findViewById(R.id.drawer_layout_pc);
        NavigationView navigationView = findViewById(R.id.navigation_view_pc);


        fstore= FirebaseFirestore.getInstance();
        collectionReference=fstore.collection("personal_care");
        recyclerView= findViewById(R.id.recyclepc);
        storageReference = FirebaseStorage.getInstance().getReference();

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("personal_care").orderBy("Price", Query.Direction.ASCENDING);
            ...
            public void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final cosmeticModelClass cosmeticModelClass) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(PersonalCareActivity.this,ClothLandingActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_home:
                        Intent intent4 = new Intent(PersonalCareActivity.this, MainActivity.class);
                        startActivity(intent4);
                        break;

                    case R.id.order:
                        Intent intent43 = new Intent(PersonalCareActivity.this, OrderHistoryActivity.class);
                    ...
                    case R.id.store:
                        ...
                        break;
                    case R.id.About:
                        Toast.makeText(PersonalCareActivity.this, "About Content Needed",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.women:
                        Intent intent16 = new Intent(PersonalCareActivity.this, WomenActivity2.class);
                        startActivity(intent16);
                        break;
                    case R.id.men:
                        Intent intent2 = new Intent(PersonalCareActivity.this, MenActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.cos:
                        Intent intent3 = new Intent(PersonalCareActivity.this, CosmeticActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.signout:
                        FirebaseAuth.getInstance().signOut();
                        Intent intent31 = new Intent(PersonalCareActivity.this, LoginwithEmailActivity.class);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            try{
                ...
                Toast.makeText(PersonalCareActivity.this, "error= "+e, Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
