...
public class TopWomenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_women);

        MaterialToolbar toolbar = findViewById(R.id.topAppBartops);
        DrawerLayout drawerLayout = findViewById(R.id.drawer_layout_tops);
        NavigationView navigationView = findViewById(R.id.navigation_view_tops);
        fstore= FirebaseFirestore.getInstance();
        collectionReference=fstore.collection("top_women");
        recyclerView= findViewById(R.id.recycletops);
        storageReference = FirebaseStorage.getInstance().getReference();

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("top_women").orderBy("Price", Query.Direction.ASCENDING);
            ...
            public void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final cosmeticModelClass cosmeticModelClass) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(TopWomenActivity.this,ClothLandingActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_home:
                        Intent intent4 = new Intent(TopWomenActivity.this, MainActivity.class);
                        startActivity(intent4);
                        break;

                    case R.id.order:
                        Intent intent43 = new Intent(TopWomenActivity.this, OrderHistoryActivity.class);
                    ...
                    case R.id.store:
                        ...
                        break;
                    case R.id.About:
                        Toast.makeText(TopWomenActivity.this, "About Content Needed",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.women:
                        Intent intent16 = new Intent(TopWomenActivity.this, WomenActivity2.class);
                        startActivity(intent16);
                        break;
                    case R.id.men:
                        Intent intent2 = new Intent(TopWomenActivity.this, MenActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.cos:
                        Intent intent3 = new Intent(TopWomenActivity.this, CosmeticActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.signout:
                        FirebaseAuth.getInstance().signOut();
                        Intent intent31 = new Intent(TopWomenActivity.this, LoginwithEmailActivity.class);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            try{
                ...
                Toast.makeText(TopWomenActivity.this, "error= "+e, Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
