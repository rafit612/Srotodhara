...
public class SkirtsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialToolbar toolbar = findViewById(R.id.topAppBarskirts);
        DrawerLayout drawerLayout = findViewById(R.id.drawer_layout_skirts);
        NavigationView navigationView = findViewById(R.id.navigation_view_skirts);
        fstore= FirebaseFirestore.getInstance();
        collectionReference=fstore.collection("skirts");
        recyclerView= findViewById(R.id.recycleskirts);
        storageReference = FirebaseStorage.getInstance().getReference();

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("skirts").orderBy("Price", Query.Direction.ASCENDING);
            ...
            public void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final cosmeticModelClass cosmeticModelClass) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(SkirtsActivity.this,ClothLandingActivity.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull @org.jetbrains.annotations.NotNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_home:
                        Intent intent4 = new Intent(SkirtsActivity.this, MainActivity.class);
                        startActivity(intent4);
                        break;

                    case R.id.order:
                        Intent intent43 = new Intent(SkirtsActivity.this, OrderHistoryActivity.class);
                    ...
                    case R.id.store:
                        ...
                        break;
                    case R.id.About:
                        Toast.makeText(SkirtsActivity.this, "About Content Needed",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.women:
                        Intent intent16 = new Intent(SkirtsActivity.this, WomenActivity2.class);
                        startActivity(intent16);
                        break;
                    case R.id.men:
                        Intent intent2 = new Intent(SkirtsActivity.this, MenActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.cos:
                        Intent intent3 = new Intent(SkirtsActivity.this, CosmeticActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.signout:
                        FirebaseAuth.getInstance().signOut();
                        Intent intent31 = new Intent(SkirtsActivity.this, LoginwithEmailActivity.class);
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            try{
                ...
                Toast.makeText(SkirtsActivity.this, "error= "+e, Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
