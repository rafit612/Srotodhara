...
LinearLayout resent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit=findViewById(R.id.imageView57);
        number=findViewById(R.id.textView3);
        resent=findViewById(R.id.linearLayout2a);
        resent.setVisibility(View.GONE);
        countDown=findViewById(R.id.textViewcount);
            ...
            public void onClick(View v) {
                ...
                mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        ...
                        Toast.makeText(EnterOTPActivity.this,"onVerificationFailed:  "+e.getMessage(),Toast.LENGTH_LONG).show();
                    ...
                    public void onCodeSent(@NonNull String verificationId,
                        ...
                        Toast.makeText(EnterOTPActivity.this,"OTP send Successfully",Toast.LENGTH_LONG).show();
                ...
                PhoneAuthOptions options =
                        PhoneAuthOptions.newBuilder(firebaseAuth)
                                ...
                                .setActivity(EnterOTPActivity.this)                 // Activity (for callback binding)
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              if(otp.getText().toString().isEmpty()){
                  ...
                  Toast.makeText(EnterOTPActivity.this,"Please input OTP",Toast.LENGTH_LONG).show();

              }
              else if(otp.getText().toString().length()<6){
                  progressDialog.dismiss();
                  Toast.makeText(EnterOTPActivity.this,"Please input OTP correct",Toast.LENGTH_LONG).show();

              }
              else if(backedotp==null){
                  progressDialog.dismiss();
                  Toast.makeText(EnterOTPActivity.this,"Please check internet for OTP",Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(EnterOTPActivity.this,"Registration Success",Toast.LENGTH_LONG).show();
                           ...
                           progressDialog.dismiss();
                            Toast.makeText(EnterOTPActivity.this,"Registration Failed",Toast.LENGTH_LONG).show();
